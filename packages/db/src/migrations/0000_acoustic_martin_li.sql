...
CREATE UNIQUE INDEX "idx_join_requests_unique_pending" ON "join_requests" USING btree ("workspace_id","user_id") WHERE "join_requests"."status" = 'pending';--> statement-breakpoint

...
export function passwordResetEmailHtml(resetUrl: string): string {
  ...
  <a href="${resetUrl}" style="display: inline-block; padding: 12px 24px; background: #1a56db; color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 14px; font-weight: 600;">비밀번호 재설정하기</a>
